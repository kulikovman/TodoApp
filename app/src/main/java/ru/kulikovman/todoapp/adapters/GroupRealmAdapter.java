...
public class GroupRealmAdapter extends RecyclerView.Adapter<GroupRealmAdapter.GroupHolder> {
    private static GroupRealmAdapter.OnItemClickListener mListener;
    ...
    public GroupRealmAdapter(Context context, List<Group> groups) {
        mGroups = groups;
        mContext = context;
    }

    @Override
    public GroupRealmAdapter.GroupHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_group, parent, false);
        return new GroupRealmAdapter.GroupHolder(v);
    }
